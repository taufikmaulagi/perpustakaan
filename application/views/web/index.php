...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?=base_url('web/proses')?>" method="post">
		...
		<div class="form-actions">
			...
			<input type="checkbox" name="remember" value="1"/>Ingat Password </label>
...
<div class="copyright">
	 2020 © Kelompok 3. Perpustakaan Sekolah.
</div>
<!-- END LOGIN -->
